...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const defaultDonations = [
        ...
        { name: 'Mussie Kaplan', amount: 100 },
        { name: 'Mendy Tevardovitz', amount: 36 },
        { name: 'Shmulie Grossbaum', amount: 1 },
        { name: 'Kasriel and Chana E Shemtov', amount: 36 },
        { name: 'Anonymous', amount: 36 },
        { name: 'Pinchas Mamane', amount: 500 },
        { name: 'Malka Fogel', amount: 72 },
        { name: 'Sender Pollon', amount: 18 },
        { name: 'Mordechai Korf', amount: 770 },
        { name: 'Yossi Sasonkin', amount: 3 },
        { name: 'Sara Schtroks/Aunty Suri', amount: 36 },
        { name: 'Anonymous', amount: 54 },
        { name: 'Anonymous', amount: 180 },
        { name: 'Sara Kaplan', amount: 18 },
        { name: 'Fm Schusterman', amount: 36 },
        { name: 'Chani & Ephraim', amount: 180 },
        { name: 'Anonymous', amount: 18 },
        { name: 'Yossell Vaisfiche', amount: 10 },
        { name: 'Eliran Itzhakov', amount: 20 },
        { name: 'Anonymous', amount: 18 },
        { name: 'Anonymous', amount: 50 },
        { name: 'Osg', amount: 18 },
        { name: 'Don Yaakov', amount: 18 },
        { name: 'Nochum Rabin', amount: 18 },
        { name: 'David & Eda Schottenstein', amount: 100 },
        { name: 'Melie Greenbaum', amount: 100 },
        { name: 'Shneur & Devora Leah Stern', amount: 36 },
        { name: 'William Beyer', amount: 36 },
        { name: 'Levi N', amount: 50 },
        { name: 'Caleiv Schylander', amount: 11 },
        { name: 'Tatty Schylander', amount: 200 },
        { name: 'Aline Elkayam', amount: 100 },
        { name: 'Nechama Dina & Shloime', amount: 500 },
        { name: 'Reuven Cheruff', amount: 36 },
        { name: 'Anonymous', amount: 50 },
        { name: 'Moishy Goldberg', amount: 36 },
        { name: 'Daniel Benchimol', amount: 18 },
        { name: 'Anonymous', amount: 36 },
        { name: 'Yehudah Fridman', amount: 18 },
        { name: 'Chabad Ocala & The Villages', amount: 100 },
